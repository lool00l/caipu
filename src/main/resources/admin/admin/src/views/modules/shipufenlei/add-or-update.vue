<template>
	<div class="addEdit-block" :style='{"minHeight":"100vh","padding":"30px","fontSize":"14px","color":"#666","background":"#e9ecf3"}'>
		...
		>
			<template >
				<el-form-item :style='{"border":"0px solid #eee","padding":"0","margin":"0 0 36px 0","color":"inherit","borderRadius":"0px","width":"auto","fontSize":"inherit"}' class="input" v-if="type!='info'"  label="食谱分类" prop="shipufenlei">
					<el-input  v-model="ruleForm.shipufenlei" placeholder="食谱分类" clearable  :readonly="ro.shipufenlei"></el-input>
				</el-form-item>
				<el-form-item :style='{"border":"0px solid #eee","padding":"0","margin":"0 0 36px 0","color":"inherit","borderRadius":"0px","width":"auto","fontSize":"inherit"}' v-else class="input" label="食谱分类" prop="shipufenlei">
					<el-input v-model="ruleForm.shipufenlei" placeholder="食谱分类" readonly></el-input>
				</el-form-item>
			</template>
